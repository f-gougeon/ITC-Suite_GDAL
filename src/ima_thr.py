...
#	Trying to find a arcpy function that will list which Tool I am in

#from ArcGISPro.Framework import FrameworkApplication
#current_tool = FrameworkApplication.CurrentTool
#print(current_tool)

#print(arcpy.func_name)

#print(arcpy.ListTools())

#arcpy.AddMessage(arcpy.ListTools())
